<header class="absolute bg-white top-0 w-screen z-50">
    ...
    <nav class="shadow-xl py-5 px-24 flex justify-evenly items-center">
        ...
        <ul class="flex gap-8">
            <li class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"><a href="/annuaire/templates/includes/annuaire.inc.php"
                    class="shadow-[0_1px_10px_1px_rgba(0,0,0,0.4)] p-4 rounded text-[#00a5a5] font-semibold">Annuaire</a>
            </li>
            <li class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"><a href="/annuaire/templates/includes/connexion.inc.php" class="shadow-[0_1px_10px_1px_rgba(0,0,0,0.4)] p-4 rounded text-[#00a5a5] font-semibold">Mon
                    compte</a></li>
        </ul>
