...
<body>
    ...
    <div class="mt-36 flex justify-center items-center">
        <form action="#" method="post" class="bg-white shadow-[0_1px_10px_1px_rgba(0,0,0,0.4)] w-screen sm:w-[800px] p-10 rounded-lg">
            ...
            <div class="flex mt-10 gap-6 justify-center items-center">
                <input type="text" name="prenom" placeholder="Prénom" class="w-[180px] sm:w-60 p-4 border-[#d1d1d1] border-2 rounded bg-[#f3f3f3]"
                    value="<?php echo $etudiant['prenom']; ?>" required>
                <input type="text" name="nom" placeholder="Nom" class="w-[180px] sm:w-60 p-4 border-[#d1d1d1] border-2 rounded bg-[#f3f3f3]"
                    value="<?php echo $etudiant['nom']; ?>" required>
            </div>
            <div class="mt-10 flex justify-center items-center">
                <input type="mail" name="mail" placeholder="E-mail" class="w-[460px] sm:w-[505px] p-4 border-[#d1d1d1] border-2 rounded bg-[#f3f3f3]"
